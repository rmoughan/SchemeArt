...
class Procedure:
    ...
    def eval_call(self, operands, env):
        ...
        # BEGIN PROBLEM 5
        arguments = operands.map(lambda expr: scheme_eval(expr, env))
...
def make_let_frame(bindings, env):
    ...
    while bindings != nil:
        ...
        formals, values = Pair(bindings.first.first, formals), Pair(scheme_eval(bindings.first.second.first,env), values)
